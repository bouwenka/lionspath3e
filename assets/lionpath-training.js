// LionsPath guided help: goal routes and page-specific visual walkthroughs.
...
const TRAINING_ROUTES = {
  ...
  military: {
    ...
    steps:[
      { page:'enlistment', label:'Enlistment', button:'Compare Service Routes', target:'#page-enlistment .deep-grid, #page-enlistment .branch-strip', action:'Compare at least two entry routes, review branch and career-family information, and read Before signing anything.', done:'Move on when you have one possible route and one question about the obligation or contract.' },
...
const TRAINING_TOURS = {
  ...
  enrollment: {
    ...
    frames:[
      ...
      { src:'assets/training/tours/enrollment/enrollment-09-counselor.webp', title:'9. Prepare the counselor conversation', text:'Check the questions you want to bring to your counselor, including course readiness, application timing, cost, credit, and transfer questions. Use the LCHS School Counseling panel at the bottom of the page to find your counselor or schedule an appointment, then bring saved courses, deadlines, cost questions, and anything that still needs verification.', alt:'Enrollment counselor-question checklist and LCHS School Counseling actions.', focus:{x:1,y:35,w:98,h:62}, cueTop:true }
    ]
  },
  employment: {
    ...
    frames:[
      ...
      { src:'assets/training/tours/employment/employment-08-counselor.webp', title:'8. Prepare the counselor conversation', text:'Select the counselor questions that matter to you and record program findings, wage questions, experience ideas, and anything that still needs verification in My Plan. Use the LCHS School Counseling panel at the bottom of the page to find your counselor or schedule an appointment.', alt:'Employment resource links, counselor-question checklist, and LCHS School Counseling actions.', focus:{x:1,y:32,w:98,h:65}, cueTop:true }
    ]
  },
  enlistment: {
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  catch (error) { console.error('LionsPath Help failed to initialize:', error); }
});
